  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="flex items-center gap-2 border border-[#1c67d2]/30 text-[#1c67d2]
          px-5 py-2 rounded-xl shadow hover:shadow-md hover:border-[#1c67d2] transition"
      >
        <svg
        ...
        <span className="font-medium">+91 70305 00240</span>
      </a>
    </motion.nav>
  );
};
